...
class _HomePageState extends State<HomePage> {
  ...
  AnimationStateManagement animationStateManagement=AnimationStateManagement.instance;
...
backToMainPageAnimation(double w,double h,Curve curve)
{
  containerAnimationPerform(w,h,curve)
